...
export function CrudUser() {
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setProduct(emptyProduct);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Producto Borrado', life: 3000 });
    }
...
*/}            </React.Fragment>
    ...
    const header = (
        <div className="table-header">
            <h5 className="p-m-0">Gestión de Products</h5>
        ...
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    currentPageReportTemplate="Viendo ({first} - {last}) de ({totalRecords}) productos"
...
{/*                    <Column field="rating" header="Opinión" body={ratingBodyTemplate} sortable></Column> */}
                    <Column field="inventoryStatus" header="Estado" body={statusBodyTemplate} sortable></Column>
...
{/*                {product.image && <img src={`assets/demo/images/product/${product.image}`} onError={(e) => e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} alt={product.image} className="product-image" />} */}
                <div className="p-field">
                    ...
                    {submitted && !product.name && <small className="p-invalid">Nombre (requerido).</small>}
                </div>
                <div className="p-field">
                ...
                <div className="p-field">
                    ...
                    <div className="p-formgrid p-grid">
                        ...
                        <div className="p-field-radiobutton p-col-6">
                            ...
                            <label htmlFor="category4">Deportes</label>
                        </div>
                    </div>
                </div>
            ...
            <Dialog visible={deleteProductDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                <div className="confirmation-content">
                    ...
                    {product && <span>¿Confirma ELIMINAR <b>{product.name}</b>?</span>}
                </div>
            </Dialog>
            ...
            <Dialog visible={deleteProductsDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductsDialogFooter} onHide={hideDeleteProductsDialog}>
                <div className="confirmation-content">
                    <i className="pi pi-exclamation-triangle p-mr-3" style={{ fontSize: '2rem' }} />
                    {product && <span>¿Confirma ELIMINACIÓN de los productos seleccionados?</span>}
                </div>
            </Dialog>
        </div>
    );
